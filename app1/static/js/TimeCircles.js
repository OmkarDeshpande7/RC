        ...
        if (!this.config.t){
            ...
            if (curDate > this.data.attributes.ref_date) {
                for(var i = 0; i < this.data.drawn_units.length; i++) {
                    ...
                    document.getElementById("err_found").disabled = true;
                document.getElementById("err_found").style.backgroundColor = "red";
                window.location.href="/app1/score/";
                }
